...
class AlexaSync extends React.Component {
  ...
  async componentDidUpdate(prevProps) {
    if (
      this.props.showConfirmation !== prevProps.showConfirmation &&
    ...
    return (
      <Content>
        <Card transparent style={styles.center}>
          <CardItem>
            <Text note>
              To sync a new device you must first enable the Event Loop Alexa
              skill on your Alexa device. To sync device please follow the two
              steps listed below. Remember to confirm the request to complete
              the process.
            </Text>
          </CardItem>
        </Card>
        <Card transparent style={styles.center}>
          ...
          <CardItem>
            <Text note>Say: 'Alexa, Open Event Loop.' (Wait for response)</Text>
          </CardItem>
          <CardItem>
            <Text note>
              Say: 'Device Code {this.props.syncCode}.' (You will get a prompt
              to confirm pairing.)
            </Text>
          </CardItem>
        </Card>
