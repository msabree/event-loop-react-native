    ...
    return (
      <Content>
        <BasicModal
          ...
          onRequestClose={() => {
            this.props.closeEditUserInfoModal();
          }}
          content={
            <View>
              <Form>
                <Item stackedLabel>
                  ...
                  <Input
                    ...
                    onChangeText={text => {
                      this.props.changedDisplayNameText(text);
                    }}
                  />
                </Item>
                <Item stackedLabel last>
                  ...
                  <Input
                    ...
                    onChangeText={text => {
                      this.props.changedUsernameText(text);
                    }}
                  />
                </Item>
              </Form>
        ...
        <Card style={styles.center}>
          ...
          <CardItem transparent>
            <Text>
              {this.props.loggedInDisplayName || this.props.loggedInUsername}
            </Text>
            <Button
              transparent
              onPress={() => {
        ...
        <Card transparent style={styles.center}>
          ...
          <CardItem>
            <Textarea
              ...
              bordered
              onChangeText={value => {
                this.props.inputChange('appFeedback.feedback', value);
              }}
