      ...
      <Content>
        <CardItem transparent>
          <Item regular>
            <Input
              ...
              onChangeText={value =>
                this.props.inputChange('videoChatEvent.title', value)
              }
            />
          </Item>
        </CardItem>
        <CardItem transparent>
          <Item regular>
            <Input
              ...
              onChangeText={value =>
                this.props.inputChange('videoChatEvent.meetingLink', value)
              }
            />
          </Item>
        </CardItem>
        ...
        <CardItem transparent>
          <Textarea
            ...
            bordered
            onChangeText={value => {
              this.props.inputChange('videoChatEvent.details', value);
            }}
